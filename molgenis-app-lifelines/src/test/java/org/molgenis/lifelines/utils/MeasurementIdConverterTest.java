...
public class MeasurementIdConverterTest
{
	...
	{
		String measurementProtocolIdentifier = "4:2.16.840.1.113883.2.4.3.8.1000.54.5.2_1/2.16.840.1.113883.2.4.3.8.1000.54.5.6_11";
	...
	public void toOmxProtocolIdentifier()
	{
		...
		String measurementProtocolIdentifier = MeasurementIdConverter.toOmxProtocolIdentifier(catalogReleaseId,
				cohortCode, cohortCodeSystem, measurementCode, measurementCodeSystem);
		assertEquals(measurementProtocolIdentifier,
				"4:2.16.840.1.113883.2.4.3.8.1000.54.5.2_1/2.16.840.1.113883.2.4.3.8.1000.54.5.6_11");
	}
}
